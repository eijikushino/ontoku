...
# address_code: 16bit値を20bit上位詰め（4bit左シフト）した5桁HEX
# FFFF → FFFF0, 0000 → 00000
LBC_TEST_POINTS: List[LBCTestPoint] = [
    LBCTestPoint("1/1", "FFFF0", "FFFF H", +6.180, -6.180, 0.062, "±6.180±0.062"),
    LBCTestPoint("1/1", "00000", "0000 H", -6.180, +6.180, 0.062, ""),
    LBCTestPoint("1/2", "FFFF0", "FFFF H", +3.090, -3.090, 0.031, "±3.090±0.031"),
    LBCTestPoint("1/2", "00000", "0000 H", -3.090, +3.090, 0.031, ""),
    LBCTestPoint("1/4", "FFFF0", "FFFF H", +1.545, -1.545, 0.015, "±1.545±0.015"),
    LBCTestPoint("1/4", "00000", "0000 H", -1.545, +1.545, 0.015, ""),
]
